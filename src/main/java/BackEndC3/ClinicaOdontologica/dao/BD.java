...
public class BD {
    ...
    private static final String SQL_DROP_CREATE_PAC =
    ...
    private static final String SQL_PRUEBA =
            "INSERT INTO PACIENTES (NOMBRE, APELLIDO, CEDULA, FECHA_INGRESO, DOMICILIO_ID, EMAIL, ODONTOLOGO_ID) " +
                    ...
                    "('German', 'Fraire', '22222', '2024-05-10', 2, 'german@german.com', 2); " +
                    "INSERT INTO DOMICILIOS (CALLE, NUMERO, LOCALIDAD, PROVINCIA) " +
                    "VALUES ('Siempre Viva', 742, 'Springfield', 'USA'), ('Av. Uruguay', 345, 'Punta del Este', 'Uruguay');";
